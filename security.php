...
function setupSecureSession() {
    // Se a sessão já está ativa, não alterar ini_set de sessão
    if (session_status() === PHP_SESSION_ACTIVE) {
        // Atualizar controle de atividade e sair
    ...
    // Configurações de sessão seguras (apenas antes de iniciar sessão)
    if (!headers_sent()) {
